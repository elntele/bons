...
public class NetworkProfile implements INetwork {
	...
	public NetworkProfile(Link[][] links, Vector<Node> nodes, int networkLoad,
	...
	/**
	 * Método acessor para obter o valor do atributo nodes.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo meanRateBetweenCalls.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo numOfCalls.
	 * 
