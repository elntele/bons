...
import static br.bons.core.SimonUtil.C;
import static br.bons.core.SimonUtil.getFWMPower;
...
public class Fiber {
	...
	public double getRuidoAditivo(int lambda) {
		// TODO: estava sem return na versão original C++
		return 0.0;
	}
	...
	public void allocate(int lambda_par, double potInicialEmWatt_par) {
		// o parametro de potencia inicial tem q vir já com a a perda do
		// switch
		...
		if (dynamicGain) {
			...
			// Se ganho não for dinâmico, getGain_mpu retorna G0
	...
	public double getSumPowerFWMNew(int usarLambda_par, Vector<Node> vectorOfNodes_par) {
		...
		// procuraram as combinações de canais que geram o FWM
		...
		for (FWMCombination combination : combinations){
			...
			// se a combinção existe e os canais foram alocados
	...
	/**
	 * Método acessor para obter o valor do atributo sourceNode.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo destinationNode.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo dynamicGain.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo muxDemuxGain.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo gain.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo coeficienteAtenuacao.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo sumPowerA.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo sumPowerB.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo sumPowerC.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo sumPowerD.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo sumPowerE.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo sumPowerF.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo powerA.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo powerB.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo powerC.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo powerD.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo powerE.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo powerF.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo fwmNoise.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo frequencies.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo booster.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo preAmplifier.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo time.
	 * 
