...
public class CallList {
	...
	/**
	 * Cover all the list and pull away the calls that have finished - função
	...
	/**
	 * Método acessor para obter o valor do atributo listaChamadas.
	 * 
	...
	/**
	 * Método acessor para obter o valor do atributo numEstablishedCalls.
	 * 
