...
import static br.bons.core.SimonUtil.*;
...
public class Dijkstra {
	public static void dijkstra_fnb(Link[][] matAdj_par, int fonte_par, int dest_par, Vector<Link> caminho_par,
		...
		Vector<Integer> S = new Vector<Integer>(); // conterá todos os nós para
													// os quais já se foi
		// encontrado o caminho com menor fator de ruído
		Vector<Integer> Q = new Vector<Integer>(); // conterá os nós para os
													// quais ainda não foram
		// encontrados os caminhos com menor fator de ruído
		double[] d; // vetor de distancias: conterá o valor do menor fator de
		// ruído entre a origem e o nó (índice do vetor)
		int[] father; // indica o nó anterior de cada nó
	...
	/********************************************************************
	 * DETERMINAÇÃO DE ROTAS ---- DIJKSTRA POR MINIMO FATOR DE RUÍDO
	 *********************************************************************/
