package br.bons.rwa;
import static br.bons.core.Fiber.ESPACAMENTO_FREQUENCIA;
import static br.bons.core.Fiber.FREQUENCIA_FINAL;
import static br.bons.core.SimonUtil.B0;
import static br.bons.core.SimonUtil.C;
import static br.bons.core.SimonUtil.D0;
import static br.bons.core.SimonUtil.LAMBDA0;
import static br.bons.core.SimonUtil.PLANCK;
import static br.bons.core.SimonUtil.S0;
	...
	public static double calculoPmd_fnb(Vector<Link> path_par, double taxaBits_par, double Dpmd_par, boolean pmd_par) {
		...
		if (pmd_par == true) {
			...
			for (int i = 0; i < path_par.size(); i++) {
				// multiplica por 1000, pois é em metros
