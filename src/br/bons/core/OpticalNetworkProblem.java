...
import static br.bons.core.SimonUtil.LAMBDA_FIRSTFIT;
import static br.bons.core.SimonUtil.UTILIZAR_DIJ;
import static br.bons.rwa.Funcoes.INF;
...
import br.bons.model.cost.capex.CapexEvaluator;
import br.bons.model.cost.opex.EnergyConsumptionEvaluator;
import br.bons.model.performance.BlockingProbabilityEstimator;
import br.bons.model.robustness.AlgebraicConnectivityEvaluator;
import br.bons.model.robustness.NaturalConnectivityEvaluator;
...
public class OpticalNetworkProblem implements IProblem<Integer, Double> {
	...
	/**
	 * Retorna o tempo estimado para execução de um algoritmo de
	 * critografia/descriptografia quando ele for embarcado no transponder da
	 * rede óptica, considerando o tempo médio que o AES executa em software com
	 * chave de 256 bits e o tempo do algoritmo que se deseja descobrir o
	 * equivalente no transponder.
	 * 
	 * @param swTimeAes256
	 *            Tempo médio para criptografar usando o AES com chave de 256
	 *            bits
	 * @param swTime
	 *            Tempo que se deseja converter
	 * @return Tempo que o algoritmo irá requerer para executar no transponder.
	 */
	...
	/**
	 * Teste da função que converte para os tempos do tramsponder
	 */
	public static void main(String[] args) {
		//os três tempos a seguir devem ser os tempos que você obtém em tempo de execução
		double tempoAES256 = 1548;
		double tempo3DES = 6720;
		double tempoRC4 = 7290;
		
		//os três tempos a seguir são os tempos que você vai lançar no banco de dados (x 1e6)
	...
	public Double[] evaluate(Integer[] variables) {
		...
		// criar a restrição manualmente, colocando todos para o máximo
		// quando a conectividade algébrica é zero
